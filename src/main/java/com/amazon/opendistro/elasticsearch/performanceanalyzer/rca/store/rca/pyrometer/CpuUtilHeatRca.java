...
public class CpuUtilHeatRca extends Rca<DimensionHeatFlowUnit> {
    ...
    @Override
    public DimensionHeatFlowUnit operate() {
        System.out.println("Executing: " + name());
        DimensionHeatFlowUnit flowUnit = ResourceHeatCalculator.getResourceHeat(
                shardStore,
